            ...
            <div class="container flex items-center max-w-8xl mx-auto px-4 lg:px-8">
                <div class="flex items-center">
                    <a href="/" title="{{ $page->siteName }} home" class="inline-flex items-center">
                        ...
                        <h1 class="text-lg md:text-4xl text-white font-black my-0 bg-gradient-to-br from-blue-500 to-purple-600 px-8 py-1 rounded-lg sm:rounded-b-lg sm:rounded-t-none transform hover:-translate-y-1 sm:pt-6 italic">
